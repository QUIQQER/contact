define('package/quiqqer/contact/bin/controls/frontend/ContactHub', [
    ...
    return new Class({
        ...
        Type: 'package/quiqqer/contact/bin/controls/frontend/ContactHub',
        Extends: QUIControl,
        ...
        switchView: function (name) {
            ...
            layout.dispatchEvent(new CustomEvent('quiqqer-contact-contactHub-viewChange', {bubbles: true}));
        ...
        $showAiError: function (host) {
            ...
            message.textContent = QUILocale.get(lg, 'contact.contactHub.aiError');
            const back = document.createElement('button');
            back.type = 'button';
            back.className = 'btn btn-primary';
            back.textContent = QUILocale.get(lg, 'contact.contactHub.overview');
         ...
         * ContactHub instance; the ai control is mounted by whichever instance
         * wins the DOM guard, not necessarily the one a caller (e.g.
         * ContactHubWindow) holds a reference to. A DOM event reaches listeners
         * regardless of which instance did the mount.
         *
         * @param {HTMLElement} host - the ai host element
         */
        $notifyAiMounted: function (host) {
            host.dispatchEvent(new CustomEvent('quiqqer-contact-contactHub-aiMounted', {
                bubbles: true
            }));
        },
        ...
        send: function () {
            ...
            if (!form) {
                return Promise.reject(new Error(QUILocale.get(lg, 'contact.contactHub.formDisabled')));
            }
                    ...
                    QUIAjax.post('package_quiqqer_contact_ajax_contactHub_send', () => {
                        ...
                        moofx(nodes).animate({
                            ...
                            callback: () => {
                                ...
                                this.getElm().classList.add('quiqqer-contact-contactHub--success');
        ...
        getControlAttributes: function () {
            ...
            return {
                ...
                predefinedButtons: this.getAttribute('predefinedButtons'),
        ...
        getSuccessHtml: function () {
            ...
            if (!message || message.length === 0) {
                message = QUILocale.get(lg, 'contact.contactHub.send.success');
            }

            return new Promise((resolve) => {
                require([
                    'Mustache',
                    'text!package/quiqqer/contact/bin/controls/frontend/ContactHub.Success.html',
                    'css!package/quiqqer/contact/bin/controls/frontend/ContactHub.Success.css',
