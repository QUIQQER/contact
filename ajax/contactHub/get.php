...
/**
 * Renders the ContactHub control.
 *
...
QUI::getAjax()->registerFunction(
    ...
    function ($attributes, $brickParams) {
        ...
        if ($brickId > 0) {
            ...
            if (!$Brick || !$Brick->isInstanceOf(ContactHub::class)) {
