define('package/quiqqer/contact/bin/controls/frontend/ContactHubWindow', [
    ...
    'css!package/quiqqer/contact/bin/controls/frontend/ContactHubWindow.css'
    ...
    return new Class({
        ...
        Type: 'package/quiqqer/contact/bin/controls/frontend/ContactHubWindow',
        ...
        options: {
            ...
            // parameters handed to the ContactHub brick and, from there, to
        ...
        $loadContent: function () {
            ...
            this.$contentPromise = new Promise((resolve, reject) => {
                this.getContent().classList.add('qui-contact-controls-contactHubWindow');
                ...
                ControlContainer.classList.add('qui-contact-controls-contactHubWindow__controlContainer');
                ...
                // (possibly re-parsed) ContactHub instance wins the DOM guard - not
                // necessarily this.$contactHub. So the mount is signalled by a
                ...
                require(['package/quiqqer/contact/bin/controls/frontend/ContactHub'], (ContactHub) => {
                    ...
                    this.getContactHub().inject(ControlContainer);
                }, reject);
            });
        ...
        getContactHub: function () {
            return this.$contactHub;
        },

        send: function () {
            if (!this.getContactHub()) {
                return;
            }

            this.Loader.show();

            this.getContactHub().send().then(() => {
                this.close();
            }).catch(() => {
                this.Loader.hide();
            });
        ...
        $getSkeletonHtml: function () {
            ...
            if (Number(this.getAttribute('data-brickid')) > 0) {
                return '<div class="qui-contact-controls-contactHubWindow__skeletonLoader"'
            ...
            return `
<div class="qui-contact-controls-contactHubWindow__skeletonLoader" data-name="skeletonLoader" style="opacity: 0;" aria-hidden="true">
    <div class="quiqqer-contact-contactHub">
        ${showSidebar ? this.$getSidebarSkeletonHtml() : ''}
        <section class="quiqqer-contact-contactHub__rightContent">
            ${rightContent}
        </section>
    </div>
</div>
        ...
        $getSidebarSkeletonHtml: function () {
            return `
<aside class="quiqqer-contact-contactHub__leftContent">
...
<form class="quiqqer-contact-contactHub__form form form--${formDesign} quiqqer-contact-contactHub__form--dummy-content">
    ...
    <div class="form-actions">
        ...
        $getSelectSkeletonHtml: function () {
            return `
<div class="quiqqer-contact-contactHub__skeleton-select">
    <span class="skeleton-loader skeleton-loader-header" style="width: 60%;"></span>
    ...
    <div class="quiqqer-contact-contactHub__skeleton-choices">
        ...
        $getAiSkeletonHtml: function () {
            return `
<div class="quiqqer-contact-contactHub__skeleton-ai">
    <span class="quiqqer-contact-contactHub__skeleton-ai-spinner fa fa-circle-o-notch fa-spin" aria-hidden="true"></span>
</div>`;
        }
    });
});
